...
knitr::include_graphics("archived_docs/flowchart/high_level_flow.png")
```
...
knitr::include_graphics("archived_docs/flowchart/dengue_classification.png")
```
...
knitr::include_graphics("archived_docs/flowchart/PAHO_process_summary.png")
```
...
knitr::include_graphics("archived_docs/figure/cumulative plot for each country-26.png")
```
...
knitr::include_graphics("archived_docs/figure/heatmap-1.png")
```
...
knitr::include_graphics("archived_docs/flowchart/flow_condense.png")
```
